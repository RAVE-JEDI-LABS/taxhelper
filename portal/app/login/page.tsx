    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl text-gray-600 mt-2">Client Portal</h1>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-8">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            New client? Contact our office to set up your account.
          </p>
        </div>

        <div className="text-center text-sm text-gray-600 mt-4 space-y-2">
          <p>
            <a href="tel:+19783727050" className="text-primary-600 hover:text-primary-700">
              (978) 372-7050
            </a>
          </p>
          <p>
            <a href="https://gordonulencpa.com" className="text-primary-600 hover:text-primary-700">
              gordonulencpa.com
            </a>
          </p>
        </div>
